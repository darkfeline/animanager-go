...
func main() {
	...
	subcommands.Register(cmd.Wrap2(&cmd.Add{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.FindFiles{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Register{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Show{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.ShowFiles{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Search{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.SetDone{}), "")
	subcommands.Register(cmd.Wrap(&cmd.Stats{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.UpdateTitles{}), "")
	subcommands.Register(cmd.Wrap(&cmd.Unfinished{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Unregister{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Watch{}), "")
	subcommands.Register(cmd.Wrap2(&cmd.Watchable{}), "")
	flag.Parse()
	if debug {
		setupDebug()
	}
